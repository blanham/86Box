...
#define R128_PM4_PACKET_MAX_DWORDS  4096U
#define R128_3D_REG_DWORDS          ((0x1e00U - 0x1800U) / sizeof(uint32_t))
...
typedef struct rage128_3d_t {
    uint32_t regs[R128_3D_REG_DWORDS];
...
void rage128_host_data_finish(rage128_t *dev);

bool rage128_pm4_mm_read(rage128_t *dev, uint32_t addr,
                         unsigned int size, uint32_t *value);
bool rage128_pm4_mm_write(rage128_t *dev, uint32_t addr,
                          uint64_t data, unsigned int size);
void rage128_pm4_reset(rage128_t *dev, bool full);
void rage128_pm4_run(rage128_t *dev);
uint32_t rage128_pm4_gui_status(const rage128_t *dev);
bool rage128_pm4_read_guest(rage128_t *dev, uint32_t address,
                            void *buffer, size_t length);

bool rage128_3d_load_palette(rage128_t *dev, uint32_t datatype,
                                const uint32_t *colors,
                                unsigned int count);
bool rage128_3d_mm_read(rage128_t *dev, uint32_t addr,
                        unsigned int size, uint32_t *value);
bool rage128_3d_mm_write(rage128_t *dev, uint32_t addr,
                         uint64_t data, unsigned int size);
void rage128_3d_reset(rage128_t *dev);
bool rage128_3d_surface_fill(rage128_t *dev, uint32_t master,
                             uint32_t pitch_offset, uint32_t color,
                             uint32_t dst_xy, uint32_t width_height);
bool rage128_3d_draw_indexed(rage128_t *dev, uint32_t address,
                             uint32_t size, uint32_t format,
                             uint32_t vc_cntl,
                             const uint32_t *index_words,
                             unsigned int index_dwords);

bool rage128_3d_draw_inline(rage128_t *dev,
                                uint32_t format, uint32_t vc_cntl,
                                const uint32_t *vertex_words,
                                unsigned int vertex_dwords);

void rage128_mmio_write_reg(rage128_t *dev, uint32_t addr, uint32_t data);
void rage128_mark_vram_dirty(rage128_t *dev, uint64_t start, uint64_t length);
